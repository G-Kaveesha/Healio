...
/*
 * =========================================================
 * WORRY & ANXIETY ACTIVITIES SCREEN
 * =========================================================
 */

export default function AnxietyActivitiesScreen({
  navigation,
}) {
  const [
   ...
   * here anymore.
   *
   * An activity should be added to
   * Recent Activities only after the
   * user reaches its Complete screen.
   */
  ...
  const openActivity = (
     ...
     * IMPORTANT:
     *
     * Do NOT call addRecentActivity()
     * here.
     *
     * Opening an activity does not
     * mean the user completed it.
     *
     * Recent Activities are now
     * recorded from each activity's
     * Complete screen.
     */
     ...
     * custom interactive screen flow,
     * open its Intro screen directly.
     */
    ...
    if (
      ...
      navigation.navigate(
        ...
        {
          /*
           * These route params are
           * very important.
           *
           * Every screen in the
           * activity flow should keep
           * passing them forward using:
           *
           * {
           *   ...(route?.params || {})
           * }
           *
           * The Complete screen needs
           * activityId + category in
           * order to add the completed
           * activity to Recents.
           */
    ...
    /*
     * Fallback to reusable details
     * screen if a custom activity
  ...
  const renderActivity = ({
    ...
    return (
      <TouchableOpacity
        ...
        accessibilityHint={
          "Opens the selected worry and anxiety activity"
        }
      >
        {/* =================================================
            ACTIVITY IMAGE
        ...
        >
          ...
          <Pressable
            ...
            accessibilityHint={
              "Shows a brief explanation of the activity"
            }
          >
            <Ionicons
